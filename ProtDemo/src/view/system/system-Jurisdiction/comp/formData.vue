    ...
    <Modal v-model="showModal" width='900' :closable='false'
      ...
      <div style="overflow: auto;height: 500px;">
        <Form
          ...
          :styles="{top: '20px'}">
          <Row>
            <Col span="12" v-for="(i,index) in formInputs" :key="index">
              <FormItem :prop='i.prop' :label='i.label'>
                <Input type="text" v-model="formItem[i.prop]" :readonly="i.readonly" :placeholder="'请填写'+i.label+'...'"></Input>
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem label='状态'>
                <Select filterable clearable v-model="formItem.zt" placeholder="请填选择状态...">
                  <Option v-for='(item,index) in Dictionary' :value="item.key" :key="index">{{item.val}}</Option>
                </Select>
              </FormItem>
            </Col>
            <Col span="12">
