...
import com.cwb.news.sys.mapper.SysHdyxMapper;
import com.cwb.news.sys.mapper.SysYxhdwjMapper;
import com.cwb.news.sys.model.SysHdyx;
import com.cwb.news.sys.model.SysYh;
import com.cwb.news.sys.model.SysYxhdwj;
...
public class HdServiceImpl extends BaseServiceImpl<SysHdyx,String> implements HdService {
    ...
    private void saveFiles(SysHdyx hdyx){
        ...
        if (StringUtils.isEmpty(hdyx.getFilePaths())) {
            return;
        }
