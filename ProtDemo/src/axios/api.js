...
export default {
  ...
  Banner:{
    baseURl:imgUrl,
    SAVE:'/api/banner/save',
    GETBANNER:'/api/banner/pager',
    UPDATE:'/api/banner/update',
    DEL:'/api/banner/remove/'
  },
  Ablum:{
    GETABLUM:'/api/ablum/pager',
    SAVE:'/api/ablum/save'
  },
  JD:{
    GETJD:'/api/jd/pager',             // 1 景点 2.美食、3.住宿、4.休闲娱乐、5.特色商品
    SAVE:'/api/jd/save',
    UPDATE:'/api/jd/update',
    DEL:'/api/jd/remove/'
  },
  Video:{
    GETVIDEO:'/api/video/pager',
    SAVE:'/api/video/save',
    UPDATE:'/api/video/update',
    DEL:'/api/video/remove/'
  },
  MP:{
    GETMP:'/api/mp/pager',
    SAVE:'/api/mp/save',
    UPDATE:'/api/mp/update',
    DEL:'/api/mp/remove/'
  },
  IMG:{
    GETIMG:'/api/img/pager',             // 1 景点 2.美食、3.住宿、4.休闲娱乐、5.特色商品
    SAVE:'/api/img/save',
    UPDATE:'/api/img/update',
    DEL:'/api/img/remove/'
  },
