...
public class SysOperateLogAop {
    ...
    @Around("execution(public * com.cwb.news.sys..*.*Controller.save*(..))" +
            "|| execution(public * com.cwb.news.sys..*.*Controller.update*(..))" +
            "|| execution(public * com.cwb.news.sys..*.*Controller.remove*(..))"+
            "|| execution(public * com.cwb.news.sys..*.*Ctrl.save*(..))" +
            "|| execution(public * com.cwb.news.sys..*.*Ctrl.update*(..))" +
            "|| execution(public * com.cwb.news.sys..*.*Ctrl.remove*(..))"
    )
