...
import com.cwb.news.util.commonUtil.SnowflakeIdWorker;
...
public class OperateLogAop {
    ...
    @Around("execution(public * com.cwb.news.biz..*.*Controller.save*(..))" +
            "|| execution(public * com.cwb.news.biz..*.*Controller.update*(..))" +
            "|| execution(public * com.cwb.news.biz..*.*Controller.remove*(..))"+
            "|| execution(public * com.cwb.news.biz..*.*Ctrl.save*(..))" +
            "|| execution(public * com.cwb.news.biz..*.*Ctrl.update*(..))" +
            "|| execution(public * com.cwb.news.biz..*.*Ctrl.remove*(..))"
    )
    public Object log(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.setCzsj(DateTime.now().toDate());
